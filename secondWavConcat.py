...
try:
    while True:
        ...
        if(light_level > 800):  # state 1
            ...
            state = 0
            s = pygame.mixer.music.load('/home/pi/laserharp-sounds/off.wav')
            pygame.mixer.music.play(-1)
            print("off")
